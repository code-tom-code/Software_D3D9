...
__declspec(dllexport) BOOL WINAPI DllMain(HINSTANCE hInst,DWORD reason,LPVOID)
	{
	if (reason == DLL_PROCESS_ATTACH)
		...
		p[15] = GetProcAddress(hL,(LPCSTR)LOWORD(16)); // Apparently this is some undocumented function added in the Windows 8.1 update: "DWORD Direct3D9ForceHybridEnumeration(UINT)"
